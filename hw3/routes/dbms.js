...
var host = "104.198.11.235";    //from GCloud instance (change to match your db)
var database = "cheesecake";  //database name
var user = "root";         //username (change to match your db)
var password = "cheeseCakeMan";  //password (change to match your db, yes this is very poor practice)
